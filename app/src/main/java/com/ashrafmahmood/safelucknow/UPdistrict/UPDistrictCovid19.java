...
public class UPDistrictCovid19
{
    ...
    public UPDistrictCovid19(String state, String sTotal, String sdTotal, String sActive, String sRecov, String sdRecov, String sDeaths, String sdDeaths) {
        this.state = state;
        this.sTotal = sTotal;
